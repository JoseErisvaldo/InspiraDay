...
const initialProfiles = [
  ...
  { id: 3, name: "Carlos Determinado", photo: "https://api.dicebear.com/9.x/lorelei/svg?seed=Carlos%20Determinado", bio: "Eu sou um exemplo de determinação e iniciativa. Minha missão é motivar você a dar o primeiro passo em sua jornada, não importa quão longa seja a estrada." },
